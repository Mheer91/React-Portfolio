            ...
            <Container fluid>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav variant="pills" defaultActiveKey="/aboutme" className="justify-contents-end secondary">
                        <Nav.Link href="#aboutme" onClick={() => pageChange('Aboutme')}>About Me</Nav.Link>
                        <Nav.Link href="#portfolio" onClick={() => pageChange('Projects')}>Portfolio</Nav.Link>
                        <Nav.Link href="#contactme" onClick={() => pageChange('ContactMe')}>Contact Me</Nav.Link>
