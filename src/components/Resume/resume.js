    ...
    return(
        <Container>
            <Stack gap={4}>
                ...
                <h3><a className="text-white" href="https://docs.google.com/document/d/1hi0IBrEdgSI9lJAN2MNqs5XQshOyI8YrG5aCJyE5ZAI/edit?usp=sharing" target="_blank">Click for my resume!</a></h3>
